...
FIX_SOURCE_FILES = (
    ...
    "scripts/benchmark_r2c_stage0_profile.py",
    "scripts/supervise_r2c_stage0.py",
    ...
    "src/gnss_doppler_lab/r2c_stage0_observer.py",
    ...
    "tests/test_joint_profile_glrt_vectorized.py",
    "tests/test_r2c_stage0_durable_runner.py",
