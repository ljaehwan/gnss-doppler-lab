...
def test_followup_namespace_and_exact_repair_are_frozen():
    runner = load_runner()
    assert runner.OUTPUT == ROOT / "artifacts/pg_scc_stage0_r2_validator_repair"
    assert runner.PREREGISTRATION_SHA == "c7887316ed981d0e7cde74b2bbadeb1cf83bb233"
