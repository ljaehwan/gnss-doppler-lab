...
def test_exact_raw_binding_passes_a1_and_recovery_failure_remains_null():
    gates=r12.gate_alignment({'binding':'exact_same_raw','candidate':'registered','n':800,'prn_count':8,'dominant_fraction':.2,'within_tolerance_fraction':.94,'pooled_spearman':1,'median_prn_spearman':1,'boundary_fraction':0,'consistent_time':True})
...
def test_different_raw_fails_a1():
    gates=r12.gate_alignment({'binding':'different','candidate':'registered','n':800,'prn_count':8,'dominant_fraction':.2,'within_tolerance_fraction':1,'pooled_spearman':1,'median_prn_spearman':1,'boundary_fraction':0,'consistent_time':True})
